      ...
      <div className="relative bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl transform transition-all">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8">
            Faça login com sua conta Google para acessar o dashboard administrativo 
            e gerenciar todos os leads e relatórios.
          </p>
          ...
          <button
            ...
            className={`
              ...
              bg-white border-2 border-gray-200 rounded-lg text-gray-700 font-semibold
